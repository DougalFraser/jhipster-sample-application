package nz.gen.fraser.jhipster.sample.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.getMapConfigs().put("nz.gen.fraser.jhipster.sample.domain.*", initializeDomainMapConfig(jHipsterProperties));
